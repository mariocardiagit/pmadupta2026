...
(function () {
    ...
    function populateFieldControls() {
        ...
        const autoLabel=findCompanionLabelField(autoEntity) || detectField([/(libelle|libellé|label|intitule|intitulé|designation|désignation|nom.*activite|nom.*activité|description)/i],['text','category']) || ''; // Le rendu privilégie ensuite le dictionnaire code→libellé si la valeur détectée ressemble à un autre code.
        ...
        fillSelect('exec-label-field', textFields, 'Aucun libellé complémentaire', autoLabel);
